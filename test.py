...
def load_and_setup_model(params):
    ...
    generator.load_state_dict(torch.load("./saveModels/generator/generator_epoch.pth"))
    discriminator.load_state_dict(torch.load("./saveModels/discriminator/discriminator_epoch.pth"))
    generator.eval()
    discriminator.eval()
    return generator
